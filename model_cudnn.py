...
from keras.layers import Dense, Input, Embedding, Dropout, Bidirectional, Conv1D, MaxPool1D, Flatten, Concatenate, SpatialDropout1D
from keras.layers import CuDNNLSTM as LSTM, CuDNNGRU as GRU
