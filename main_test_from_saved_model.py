...
if __name__ == '__main__':
    ...
    nlp_model.get_bidirectional_lstm_att(embedding_matrix, str(EMBEDDING_TYPE) + '_' + str(0))   # Get lstm attention model
    y_test = nlp_model.predict_from_saved_model(list_sentences_test, model_path)
