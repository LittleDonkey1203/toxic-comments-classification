...
if __name__ == '__main__':
    ...
    EMBEDDING_TYPE = [EMBEDDING_TYPE_glove]
    ...
    embedding_index = [embeddings_index_glove]
    ...
    for train_idx, val_idx in kf.split(list_sentences_train, np.any(y_train == 1, axis = 1)):
        ...
        nlp_model.get_bidirectional_lstm_glbm(embedding_matrix, str(EMBEDDING_TYPE) + '_' + str(bagging_iter))   # Get lstm attention model
        ...
        y_tmp = y_test.copy() / (bagging_iter + 1)
